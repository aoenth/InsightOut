...
struct PieChartSlice_Previews: PreviewProvider {
    static var previews: some View {
        PieChartSlice(mood: Mood.happiness, center: CGPoint(x: 350, y: 200), radius: 300, startDegree: 90, endDegree: 90 + 90, isTouched: true, accentColor: .orange, separatorColor: .black, size: 600)    }
}
